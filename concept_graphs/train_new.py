...
def training(args):
    ...
    for ep in range(n_epoch):
        ...
        log_dict['epoch_train_loss'] = np.mean(log_dict['train_loss_per_batch'])
        ...
        with torch.no_grad():
            ...
            store_ep = [0, 1, 2, 3, 4, 9, 49, 99, 199]
            ...
            log_dict['epoch_test_loss'] = {key: [] for key in configs["test"]}

            for test_config in configs["test"]: 
                log_dict['epoch_test_loss'][test_config] = np.mean(log_dict['test_loss_per_batch'][test_config])
