...
def train_mlp(samples, hidden_dims, targets, test_samples=None, test_targets=None, batch_size=128, opt='Adam', lr=0.001, clip=0.0, use_tol=False, tol=1e-7, max_epochs=10000, use_init=None, var=1.0, folder="", m=0, debug=False):    
    """
...
def collect_clusterPredictions(hidden_dim, center_list, var_list, test_centers=None, test_vars=None, target_fn=None, alpha=0, n_test=20, k=10, lo=100, hi=110, step=10, opt='Adam', lr=0.001, clip=0.0, max_epochs=10000, use_tol=False, use_init=None, var=np.sqrt(6), folder="", debug=True):
    """
...
# randomly sample targets of far corners
